...
class RangeHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_OPTIONS(self):
        ...
        self.send_header("Access-Control-Allow-Headers", "X-Requested-With,Authorization,Range")
...
def run(path=None, port=8000):
    RangeHTTPRequestHandler.protocol_version = "HTTP/1.0"
    if path:
        RangeHTTPRequestHandler.log_path = path
    server_address = ('', port)
...
if __name__ == '__main__':
    run('/Users/yiqingjin/.airflow/logs')
